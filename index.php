    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p>Di alam bebas mereka bersimbiosis dengan anemon laut. Anemon akan melindungi Ikan badut dari
                    pemangsa dan Ikan badut akan membersihkan Anemon dengan memakan sisa - sisa makanan Anemon. </p>
                <p>Ikan badut biasa adalah ikan kecil yang tumbuh hingga 11 cm (4,3 inci). Tubuhnya bertampang
                    gempal dan berbentuk lonjong. Itu dikompresi secara lateral, dengan profil bulat. Warna tubuhnya
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <p>Paracanthurus hepatus memiliki tubuh berwarna biru dengan ekor kuning dan warna hitam pada bagian
                    atas yang berbentuk menyerupai angka 6. Ikan ini bisa tumbuh sebesar 30 cm dan berbentuk tubuh
                    bulat ramping seperti pancake. Ikan ini menyebabkan keracunan jika dimakan manusia, tetapi
    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <h1 class="display-4">Cari Berbagai Ikan</h1>
                <p class="lead">
                    Lihat berbagai jenis ikan seperti ikan hias, ikan predator, ikan laut. Jika Anda tidak menemukan
                    informasi ikan di website kami, beritahu kami detail apa yang anda inginkan serta kami akan
                    mencoba mencarikan seperti yang Anda minta.
                </p>
            </div>
        </div>
    </div>
