<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO ikan (ID_KATEGORI, NAMA_IKAN, GAMBAR, DESKRIPSI, REPRODUKSI_IKAN, PERAWATAN) VALUES ('$kategoriIkan', '$namaIkan', '$gambarIkan', '$deskripsiIkan', '$reproduksiIkan', '$perawatanIkan')";
